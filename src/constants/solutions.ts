...
export const solutions = [
	{
		...
		side: 'left',
		bullets: [
			'Suporte ao Usuário Remoto Ilimitado',
	...
	},
	{
		...
		side: 'left',
		bullets: [
			'Soluções De Produtividade Em Nuvem (office 365)',
	...
	},
	{
		...
		bullets: [
			...
			'instalação De Sistema CFTV Completo',
			'Visualização E Monitoramento Em Tempo Real',
			'Configuração De Software De Monitoramento',
